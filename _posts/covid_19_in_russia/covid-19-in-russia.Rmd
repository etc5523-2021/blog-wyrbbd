...
Russia_full <- world_covid19%>%
  filter(location == 'Russia')%>%
  filter(date == '2020-01-31'|date =='2020-02-28'|date =='2020-03-31'|date =='2020-04-30'|date =='2020-05-31'|date =='2020-06-30'|date =='2020-07-31'|date =='2020-08-31'|date =='2020-09-30'|date =='2020-10-31'|date =='2020-11-30'|date =='2020-12-31'|date =='2021-01-31'|date =='2021-02-28'|date =='2021-03-31'|date =='2021-04-30'|date =='2021-05-31'|date =='2021-06-30'|date =='2021-07-31'|date =='2021-08-30')%>%
...
So what is the progress of the vaccine in Russia? As you can see the current progress of vaccine rollout in Russia is not very fast and as of August this year, the complete vaccination rate per 100 people was only 17.33%.I believe that one of the reasons for the poor control of the outbreak in Russia is the poor progress of the vaccine. The crude oil vaccine still offers some protection, despite the emergence of new and novel coronaviruses.
